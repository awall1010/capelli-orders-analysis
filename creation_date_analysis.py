...
st.write("""
This application analyzes aggregated order data from the `aggregated_orders5.26.csv` file. Explore delivery times and shipping performance across different clubs based on the order creation dates.
""")
