...
st.write("""
This application analyzes aggregated order data from the `aggregated_orders2.23.csv` file. Explore delivery times and shipping performance across different clubs based on the order creation dates.
""")
...
# Load the data
data_file = os.path.join('shippingdates', 'aggregated_orders2.23.csv')
...
st.markdown("---")
st.write("**Note:** This analysis is based on the data available in the `aggregated_orders2.23.csv` file. Please ensure the data is up-to-date for accurate insights.")
