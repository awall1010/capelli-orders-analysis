...
def load_recent_data(filepath):
    ...
    Parameters:
    - filepath (str): Path to the aggregated_orders5.18.csv file.
...
data_file_recent = os.path.join('shippingdates', 'aggregated_orders5.18.csv')
...
st.markdown("---")
st.write("**Note:** This analysis is based on the data available in the `Capelli2023_aggregated_orders.csv` and `aaggregated_orders5.18.csv` files. Please ensure the data is up-to-date for accurate insights.")
